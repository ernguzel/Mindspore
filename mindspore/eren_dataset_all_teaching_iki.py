...
class AdvancedClassificationNet(nn.Cell):
    def __init__(self, num_classes):
        ...
        self.fc = nn.SequentialCell([
            ...
            nn.Dense(4096, num_classes)  # Çıkış boyutunu sınıf sayısına göre ayarla
        ])
...
if __name__ == '__main__':
    ...
    # Modeli oluştur
    network = AdvancedClassificationNet(num_classes)  # Sınıf sayısını FC katmanına gönder
    ...
    # Modeli kaydet
    save_checkpoint(network, "advanced_motion_detection_eren_dataset_iki.ckpt")
